 ...
 * @author  Ron Rickard
 */
public class Distribution extends Entity<Distribution> implements Comparable<Distribution> {
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof Distribution &&
            this.compareTo((Distribution)object) == 0) {
            equals = true;
        }
