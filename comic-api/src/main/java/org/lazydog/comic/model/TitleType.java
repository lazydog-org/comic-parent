...
/**
 * Entity class used to represent a title type.
 *
 * @author  Ron Rickard
 */
public class TitleType extends Entity<TitleType> implements Comparable<TitleType> {
     ...
     */
    @Override
    public int compareTo(TitleType that) {
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof TitleType &&
            this.compareTo((TitleType)object) == 0) {
            equals = true;
        }
